            ...
            request(first_product, function (err2, response2, body2) {
                ...
                if (!err2 && response2.statusCode == 200) {
                        ...
                        $(".offers-list__item").each(
                            function () {
                                var _price = $(this).find('.price__link__integer').text();
                                var _store = $(this).find('.store-logo').attr('alt');

                                var _image = $(this).find('.store-logo').attr('src');
                               ...
                               // var _star = _starfull + _starhalf / 2;
                                ...
                                var _link = $(this).find('.btn-mobile').attr('href');
                                if(_store !== undefined){
                                    store_list.push({
                                        store: _store,
                                        price: _price,
